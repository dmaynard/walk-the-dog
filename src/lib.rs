...
fn serpinsky(context: &web_sys::CanvasRenderingContext2d, points: [(f64,f64);3 ], color: (u8, u8, u8), depth: u8) {
    ...
    if depth > 0 {
        ...
        serpinsky(&context, [top,left_middle, right_middle], next_color, depth - 1);
        serpinsky(&context, [left_middle,left,bottom_middle], next_color, depth - 1);
        serpinsky(&context, [right_middle,bottom_middle,right], next_color, depth -1);
